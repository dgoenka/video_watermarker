...
// This test script is intentionally placed inside backend/dev-tools so it can be removed easily.
// It reads a filter file (dev-tools/filter.txt if present, otherwise ../filter.txt) and runs ffmpeg
